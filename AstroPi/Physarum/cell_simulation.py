...
class CellSimulation:
    def add_polar_vector(position_x, position_y, angle, distance):
        position_x += sin(angle) * distance
        position_y += cos(angle) * distance
    ...
    def rotate_cell(self: Cell):
        ...
        front_sensor_position_x, front_sensor_position_y = CellSimulation.add_polar_vector(
            ...
            self.rotation, 
            SENSOR_DISTANCE)
        front_sensor_value = VisualMap.get_square_value(front_sensor_position_x, front_sensor_position_y)
        # Left sensor
        ...
        left_sensor_position_x, left_sensor_position_y = CellSimulation.add_polar_vector(
            ...
            angle, 
            SENSOR_DISTANCE)
        left_sensor_value = VisualMap.get_square_value(left_sensor_position_x, left_sensor_position_y)
        # Right sensor
        angle = CellSimulation.check_angle_value(self.rotation - SENSOR_ANGLE)
        right_sensor_position_x, right_sensor_position_y = CellSimulation.add_polar_vector(
            ...
            angle, 
            SENSOR_DISTANCE)
        right_sensor_value = VisualMap.get_square_value(right_sensor_position_x, right_sensor_position_y)
